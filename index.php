...
<body>
    ...
    <div class="login-container">
        ...
        <h1>Welcome to CKCM Clinic</h1>
        <p>Please login to access your account.</p>
        <form action="login_process.php" method="POST">
            <input type="number" name="student_school_id" placeholder="Student School ID" required>
